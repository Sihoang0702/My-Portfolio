export const Goals = () => {
  return `<div class="testimonial_area section_gap_bottom">
  <div class="container">
      ...
      <div class="row">
          <div class="testi_slider owl-carousel">
              <div class="testi_item">
                  <div class="row">
                      <div class="col-lg-4">
                          <img src="img/banner/rsz_goals1.png" alt="">
                      </div>
                      <div class="col-lg-8">
                          <div class="testi_text">
                              <h4>Ngoại Ngữ</h4>
                              <p>Đạt 550 Toeic </p>
                              <p>Học thêm tiếng Nhật</p>
                          </div>
                      </div>
                  </div>
              </div>
              <div class="testi_item">
                  <div class="row">
                      <div class="col-lg-4">
                          <img src="img/banner/rsz_1230828522_muc-tieu-la-gi.png" alt="">
                      </div>
                      <div class="col-lg-8">
                          <div class="testi_text">
                              <h4>Web Frontend</h4>
                              <p>Sử dụng tốt các FrameWork như ReactJs, Vue.js</p>
                              <p>Thành thạo UI/UX</p>
                          </div>
                      </div>
                  </div>
              </div>
